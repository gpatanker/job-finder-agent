...
- Never use a platform that gates the actual application behind a paywall or paid membership (e.g. TheLadders' "Apply4Me" upsell, which shows the listing for free but charges $29.97+/month to actually apply). The candidate must always be able to reach the employer's real, free application from applyUrl. If a platform tries to charge to apply, search for the employer's own posting instead.
